...
function MostrarNav(){
    ...
    // Calcular cantidad del carrito PRIMERO
    $cartCount = 0;
    ...
    // Ahora definir los links usando $cartCount
    ...
    $panelAdmin = $esAdmin
        ? "<li><a class=\"dropdown-item\" href=\"{$base}/Views/Admin/usuarios.php\"><i class=\"lni lni-shield me-2\"></i>Panel Administrativo</a></li>
    ...
    $pedidosLink = !$esAdmin
        ...
        : "<li class=\"nav-item\">
              <a class=\"nav-link\" href=\"{$base}/Views/Pedido/consultarPedido.php\" style=\"color: white; font-weight: 600;\">
                <i class=\"lni lni-package me-1\"></i>Gestión Pedidos
              </a>
            </li>";
    
    $productosLink = !$esAdmin
        ? "<li class=\"nav-item\">
