...
if (!empty($_SESSION['usuario_logueado'])) {
    ...
    $rutasAdmin = [
        '/G4_AmbienteWeb/Views/Admin/',
        '/G4_AmbienteWeb/Views/Producto/tienda.php',  // Admin NO puede ver tienda
    ];
    
    // Rutas solo para CLIENTE
    $rutasCliente = [
        '/G4_AmbienteWeb/Views/Producto/carrito.php',
        '/G4_AmbienteWeb/Views/Producto/consultarProductos.php',
    ];
    
    // Rutas restringidas para ADMIN (no puede acceder como admin)
    $rutasRestringidasAdmin = [
        '/G4_AmbienteWeb/Views/Producto/tienda.php',
        '/G4_AmbienteWeb/Views/Producto/carrito.php',
        '/G4_AmbienteWeb/Views/Producto/consultarProductos.php',
    ];
